            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="divide-y divide-gray-50 mt-2">
                {stats.subjects.length === 0 ? (
                  ...
                  return (
                    <div key={subject}
                      onClick={() => navigate(`/students?subjectFilter=${encodeURIComponent(subject)}&status=Admitted&track=${encodeURIComponent(track)}`)}
                      className="flex items-center justify-between px-5 py-3.5 hover:bg-orange-50/60 transition-colors cursor-pointer group/row">
